...
RESPONSES: dict[
    ...
    ResponseId.CLARIFY_NAME: ResponseDefinition(
        ...
        text=("Sorry, could you please tell me your first and last name?"),
    ),
    ...
    ResponseId.CLARIFY_PART_A: ResponseDefinition(
        ...
        text=("Sorry, I need to confirm this. Do you currently have Medicare Part A?"),
    ),
    ResponseId.CLARIFY_PART_B: ResponseDefinition(
        response_id=ResponseId.CLARIFY_PART_B,
        text=("Sorry, I need to confirm this. Do you currently have Medicare Part B?"),
    ),
    ResponseId.CLARIFY_ZIP: ResponseDefinition(
        response_id=ResponseId.CLARIFY_ZIP,
        text=("Sorry, could you repeat your five digit ZIP code, one digit at a time?"),
    ),
    ResponseId.QUALIFIED: ResponseDefinition(
        response_id=ResponseId.QUALIFIED,
        text=("Thank you. I have the information I need."),
    ),
...
ACTION_RESPONSE_MAP: dict[
    ...
    ActionType.ASK_CONSENT: ResponseId.ASK_CONSENT,
    ActionType.ASK_NAME: ResponseId.ASK_NAME,
    ActionType.ASK_AGE: ResponseId.ASK_AGE,
    ActionType.ASK_PART_A: ResponseId.ASK_PART_A,
    ActionType.ASK_PART_B: ResponseId.ASK_PART_B,
    ActionType.ASK_ZIP: ResponseId.ASK_ZIP,
    ActionType.CLARIFY_CONSENT: ResponseId.CLARIFY_CONSENT,
    ActionType.CLARIFY_NAME: ResponseId.CLARIFY_NAME,
    ActionType.CLARIFY_AGE: ResponseId.CLARIFY_AGE,
    ActionType.CLARIFY_PART_A: ResponseId.CLARIFY_PART_A,
    ActionType.CLARIFY_PART_B: ResponseId.CLARIFY_PART_B,
    ActionType.CLARIFY_ZIP: ResponseId.CLARIFY_ZIP,
    ActionType.QUALIFIED: ResponseId.QUALIFIED,
    ActionType.DISQUALIFIED: ResponseId.DISQUALIFIED,
    ActionType.CONSENT_DECLINED: ResponseId.CONSENT_DECLINED,
}
...
def response_for_action(
    ...
    response_id = ACTION_RESPONSE_MAP.get(action_type)
