SENTENCES = [
    ...
    # MEDIUM
    {
        "id": "M01",
        "category": "MEDIUM",
        "text": "Do you currently have Medicare Part A and Part B?",
    },
    {
        "id": "M02",
        "category": "MEDIUM",
        "text": "Sorry, I didn't quite catch that. Could you say your ZIP code again?",
    },
    {"id": "M03", "category": "MEDIUM", "text": "And may I ask how old you are?"},
    {
        "id": "M04",
        "category": "MEDIUM",
        "text": "Okay, great. Thank you for confirming that.",
    },
    # LONG
    {
        "id": "L01",
        "category": "LONG",
        "text": "Okay, I have your ZIP code as seven four four two zero. Is that correct?",
    },
    {
        "id": "L02",
        "category": "LONG",
        "text": "Perfect. And just to make sure I have everything right, let me quickly go over what you told me.",
    },
    {
        "id": "L03",
        "category": "LONG",
        "text": "Thanks for your patience. I just have one more quick question before we continue.",
    },
    {
        "id": "L04",
        "category": "LONG",
        "text": "Sorry about that. I didn't quite hear the last part clearly. Could you please say it one more time for me?",
    },
    # NUMBER / DOMAIN TESTS
    {
        "id": "N01",
        "category": "NUMBER_DOMAIN",
        "text": "Your ZIP code is seven four four two zero.",
    },
    {
        "id": "N02",
        "category": "NUMBER_DOMAIN",
    ...
    },
    {
        "id": "N03",
        "category": "NUMBER_DOMAIN",
        "text": "Your date of birth is January fifteenth, nineteen fifty-eight.",
    },
    {
        "id": "N04",
        "category": "NUMBER_DOMAIN",
        "text": "I heard your age as sixty-seven. Is that correct?",
    },
]
