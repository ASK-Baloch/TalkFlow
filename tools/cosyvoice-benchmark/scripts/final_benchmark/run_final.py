...
def main():
    ...
    python_chatterbox = str(
        ROOT / "tools" / "tts-assets" / ".venv" / "Scripts" / "python.exe"
    )
    python_cosyvoice = str(
        ROOT / "tools" / "cosyvoice-benchmark" / ".venv" / "Scripts" / "python.exe"
    )
    ...
    run_cmd(
        [
            python_chatterbox,
            str(script_dir / "run_chatterbox.py"),
            str(benchmark_dir / "chatterbox_turbo"),
            str(ref_audio),
        ]
    )
    ...
    run_cmd(
        [
            python_cosyvoice,
            str(script_dir / "run_cosyvoice3.py"),
            str(benchmark_dir / "cosyvoice3"),
            str(ref_audio),
            transcript,
        ]
    )
    ...
    run_cmd(
        [
            python_cosyvoice,
            str(script_dir / "run_cosyvoice2.py"),
            str(benchmark_dir / "cosyvoice2"),
            str(ref_audio),
            transcript,
        ]
    )
